	...
	<div>
					...
					<ul class="navbar-nav me-auto mb-2 mb-lg-0">
						...
						<li class="nav-item">
							<a
								...
								:class="{ 'router-link-active-to': showScoring === true }"
								class="nav-link"
								role="button"
								data-bs-toggle="tooltip"
								data-bs-placement="bottom"
								title="How to play Who's Your Friar"
								><i class="far fa-question-circle"></i> How to</a
							>
						</li>
						...
						<ul v-if="isAuth" class="navbar-nav me-5 mb-2 mb-lg-0">
							<li class="nav-item dropdown position-relative">
								<a class="nav-link dropdown-toggle" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
									...
									></span> -->
									<span v-if="getUserPoints" class="badge bg-yellow color-brown">{{ getUserPoints[0].attributes.userPoints }}</span>
								...
								<ul class="dropdown-menu dropdown-menu-dark border-yellow mt-3" aria-labelledby="navbarDropdown" style="background-color: #2f241d">
									<li>
		...
		<Transition>
			<div v-show="showScoring" class="alert alert-warning mt-2 alert-dismissible m-3" role="alert">
				...
				<p>
					Click on "Make Your Picks" in the navigation menu and select your players for the week. Once you have selected your players, they are unavailable to pick until the round is over (
					every 4 weeks ). Every Sunday (after the game if there is one), your weekly players are reset and you may choose new players. You may choose players at any time during the week,
					but if you miss games you miss points.
				</p>
				<h5>Scoring...</h5>
				<ul>
					<li><b>Walk:</b> 1 point</li>
					<li><b>Single:</b> 1 point</li>
					<li><b>Double:</b> 2 points</li>
					<li><b>Triple:</b> 3 points</li>
					<li><b>Homerun:</b> 5 points</li>
					<li><b>RBI:</b> 2 points</li>
					<li><b>Run scored:</b> 2 points</li>
					<li><b>Stolen base:</b> 2 points</li>
				</ul>
				<h5>Tiebreakers...</h5>
				<p>
					If players are tied for points, then the player with more game points gets the higher position. If players have the same amount of points and game points, then the player who had
					the higher position the previous game will have the higher position.
				</p>
				<hr />
